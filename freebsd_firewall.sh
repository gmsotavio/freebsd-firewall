...
## Outbound IPv4 NAT
ipfw -q add 09999 nat 1 ip4 from any to any out xmit ${wan_if}

ipfw -q add 10001 allow ip4 from any to any
...
# https://www.mail-archive.com/freebsd-security@freebsd.org/msg01794.html
